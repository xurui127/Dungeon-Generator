...
public class InstantiatedRoom : MonoBehaviour
{
    ...
    /// <summary>
    ///  Blick a doorway on a tilemap layer
    /// </summary>
    ...
    private void BlockDoorwayHorizontally(Tilemap tileMap, Doorway doorway)
    {
        ...
        for (int xPos = 0; xPos < doorway.doorwayCopyTileWidth; xPos++)
        {
            ...
            {
                // Get rotation of tile being copied
                Matrix4x4 tranformMatrix = tileMap.GetTransformMatrix(new Vector3Int(startPositon.x + xPos, startPositon.y - yPos, 0));
                ...
                // Set rotation of tile copied
                tileMap.SetTransformMatrix(new Vector3Int(startPositon.x + 1 + xPos, startPositon.y - yPos, 0), tranformMatrix);
            }
        }
    }
